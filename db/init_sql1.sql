-- =============================================================
-- Bootstrap ShoriDB_1 with CDC enabled
-- =============================================================

CREATE DATABASE ShoriDB_1;
GO
...
PRINT '✔ ShoriDB_1 created, CDC enabled on all tables';
GO
...
PRINT '✔ CDC capture job tuned for ShoriDB_1';
GO

-- =============================================================
-- Bootstrap ShoriDB_2 with CDC enabled
-- =============================================================

CREATE DATABASE ShoriDB_2;
GO
...
PRINT '✔ ShoriDB_2 created, CDC enabled on all tables';
GO
...
PRINT '✔ CDC capture job tuned for ShoriDB_2';
GO
